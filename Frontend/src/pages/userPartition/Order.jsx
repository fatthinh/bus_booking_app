...
function Order() {
  ...
  useEffect(() => {
    ...
    AuthUserAxios.get(`user/list/order/${userID}`)
      .then((res) => {
  ...
  return (
    <>
      {orderDetail && (
        <div
          className="order-ticket-card absolute z-50 bg-slate-50 top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2"
          ...
          <div className="ticket cursor-pointer">
            <div className="left">
              <div className="ticket-info">
                <p className="date">
                  <span>
                    {days[new Date(orderDetail.created).getDay()].toUpperCase()}
                  </span>
                  <span
                    className={`${months[
                      new Date(orderDetail.created).getMonth()
                  ...
                  >
                    ...
                    {new Date(orderDetail.created).getDate()}TH
                  </span>
                ...
                <div className="show-name">
                  ...
                  <h2>
                    {orderDetail.start_stop.stop_name} -{" "}
                    {orderDetail.end_stop.stop_name}
                  </h2>
                </div>
                <div className="time">
                  <p>
                    {orderDetail.route_id.starting_time} <span>TO</span>{" "}
                    {orderDetail.route_id.ending_time}
                  </p>
                </div>
            ...
            <div className="right">
              <div className="right-info-container">
                ...
                <p className="text-gray-500">
                  #{orderDetail.ticket_order_id.slice(0, 8)}
                </p>
              </div>
            </div>
          </div>
      ...
      <div className="pt-24 sm:p-24 ">
        <h1 className="text-center font-bold text-2xl ">Lịch sử đặt chuyến</h1>
        ...
        <div className="relative overflow-x-auto shadow-md sm:rounded-lg">
                ...
                return (
                  ...
                  >
                    ...
                    <td className="px-6 py-4 text-center">
                      {res.start_time.split("T")[1].split("+")[0]} -{" "}
                      {res.end_time.split("T")[1].split("+")[0]}
                    </td>
          ...
          {orderList.length == 0 ? (
            <div className="font-bold text-center p-11">Không có</div>
          ) : null}
        </div>
      </div>
    </>
