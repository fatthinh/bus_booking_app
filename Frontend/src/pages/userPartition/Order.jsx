  ...
  return (
    <>
          ...
          <div className="ticket cursor-pointer">
            <div className="left">
              <div className="ticket-info">
                <p className="date">
                  <span>Ngày {new Date(orderDetail.created).getDate()}</span>
                  <span>
                    Tháng {new Date(orderDetail.created).getMonth() + 1}
                  </span>
      ...
      <div className="pt-24 sm:p-24 ">
        <h1 className="text-center font-bold text-2xl ">Lịch sử đặt vé</h1>
