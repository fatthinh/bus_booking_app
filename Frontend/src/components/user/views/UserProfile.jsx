...
function UserProfile() {
  ...
  useEffect(() => {
    ...
    UserAxios.get(`/user/details/${userID}/`)
      .then((res) => {
        console.log(res);
  ...
  const handleFormSubmit = (e) => {
    ...
    AuthUserAxios.patch(`/user/details/update/${userID}/`, formData)
      .then((res) => {
        setUserDetails(res.data);
      })
      .catch((err) => {
  ...
  const submitPassword = async (e) => {
    ...
    await AuthUserAxios.patch("/auth/update/password", formData)
      .then((res) => {
        TSuccess("password updated");
        console.log(res);
      })
      .catch((err) => {
        if (err.response.status == 403) TError("Wrong current password");
      });
  };
                ...
                <div className="col-span-6 sm:col-span-3">
                  ...
                  <div className="relative">
                    ...
                    {ShowOldPassword ? (
                      ...
                      >
                        <g>
                          <path d="M12,5C7.68,5,4,8.33,1.94,11.45L1.59,12l.36.55C4,15.67,7.68,19,12,19s8-3.33,10.06-6.45l.36-.55-.36-.55C20,8.33,16.32,5,12,5Zm0,12c-3.28,0-6.21-2.49-8-5,1.8-2.51,4.73-5,8-5s6.21,2.49,8,5C18.21,14.51,15.28,17,12,17Z"></path>
