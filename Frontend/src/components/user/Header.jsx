...
const navigation = [
  ...
  { name: "Đã chọn", href: "/bus" },
  { name: "Lịch sử", href: "/order" },
          ...
          <div className="hidden lg:flex lg:gap-x-12">
            {navigation.map((item) => (
              <a
                ...
                className="cursor-pointer hover:underline underline-offset-4 decoration-2 text-sm font-semibold leading-6 text-gray-900"
              >
                {item.name}
              </a>
            ))}
