...
function BusListCreate() {
  ...
  const FetchBusLists = () => {
    VendorAxios.get(`/vendor/bus/list/${userId}`)
      .then((res) => {
        setBusList(res.data);
      })
      .catch((err) => {
  ...
  const handleSubmit = async () => {
    ...
    if (isValid) {
      ...
      console.log(userId);
      await VendorImgAxios.post("/vendor/bus/create", formData)
        .then((res) => {
            ...
            <div className="relative w-auto my-6 mx-auto max-w-3xl">
              ...
              <div className="border-0 rounded-lg shadow-lg relative flex flex-col w-full bg-white outline-none focus:outline-none">
                ...
                <div className="flex items-start justify-between p-5 border-b border-solid border-blueGray-200 rounded-t w-80">
                  <h3 className="text-3xl font-semibold">OTP</h3>
                </div>
                {/*body*/}
                <div className="relative p-6 flex-auto">
                  <form className="p-4 md:p-5">
                    <div className="grid gap-4 mb-4 grid-cols-2">
                      <div className="col-span-2">
                        ...
                        <input
                          ...
                          name="otp"
                          id="name"
                          className="bg-gray-50 border border-gray-300 text-black text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-white dark:border-gray-500 dark:placeholder-gray-400 dark:text-black dark:focus:ring-primary-500 dark:focus:border-primary-500"
                          placeholder="Nhập..."
                          required=""
                        />
                      </div>
                    ...
                    <label className="font-mono text-sm mt-2 -mb-3">
                      Tải hình ảnh
                    </label>
      ...
      <div className="relative overflow-x-auto shadow-md sm:rounded-lg">
        <div className="flex flex-column sm:flex-row flex-wrap space-y-4 sm:space-y-0 items-center justify-between pb-4">
          ...
          <div className="relative">
            <button
              className="mx-5 mt-4 rounded-xl p-2 pl-7 pr-7 bg-green-600"
        ...
        {BusList.length == 0 ? (
          <div className="text-center p-4 m-6 font-bold">
            No bus are Created
          </div>
        ) : null}
      </div>
