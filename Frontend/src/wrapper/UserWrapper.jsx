...
const Authenticator = lazy(() =>
  import("../pages/userPartition/Authenticator")
);
...
const UserProfile = lazy(() =>
  import("../components/user/views/UserProfile.jsx")
);
const BookingConfirm = lazy(() =>
  import("../pages/userPartition/BookingConfirm")
);
const PaymentSuccess = lazy(() =>
  import("../pages/userPartition/PaymentSuccess")
);
...
function UserWrapper() {
  ...
  useEffect(() => {
    ...
    // Interceptor
    AuthUserAxios.defaults.headers.common[
      "Authorization"
